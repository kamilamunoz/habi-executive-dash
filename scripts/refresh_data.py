...
from scripts.kpis import adj_ingresos, burn, contribution, ebitda, gmv, ingresos, margen, opex
...
KPIS = [
    ...
    ("kpi_ingresos_ajustados.json", adj_ingresos),
    ("kpi_gmv.json", gmv),
    ("kpi_margen_bruto.json", margen),
    ("kpi_contribution.json", contribution),
    ("kpi_opex.json", opex),
